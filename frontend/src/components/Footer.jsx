        ...
        <div className="grid grid-cols-2 gap-6 lg:grid-cols-3 lg:gap-10">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="text-slate-400 text-sm leading-6 max-w-xs">
              Your one-stop destination for quality products, great prices and a
          ...
          <div>
            ...
            <div className="flex gap-3 mb-4">
              ...
              <p className="text-sm text-slate-400">support@shopora.com</p>
            </div>
            ...
            <div className="flex gap-3 mb-4">
              ...
              <p className="text-sm text-slate-400">+92 300 1234567</p>
            </div>
